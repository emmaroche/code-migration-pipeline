...
def code_migration():
    ...
    code_to_migrate = request_data.get('code')
    ...
    # Invoke the chain to migrate the code 
    migrated_code = chain.invoke({'question': prompt_data, 'answer': code_to_migrate})
    ...
    # Construct response
    response = {
        'original_code': code_to_migrate.strip(),

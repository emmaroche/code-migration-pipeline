...
extraction_functions = {
    "VertexAI - PaLM 2": extract_code_and_extra_content,  # Use regex-based extraction
    "VertexAI - Gemini Pro": extract_code_combined,  # Use regex-based extraction
    "VertexAI - Codey": extract_code_combined,  # Use regex-based extraction
